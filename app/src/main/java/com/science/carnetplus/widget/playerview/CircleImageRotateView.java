 ...
 * @data 2016/4/28
 */
public class CircleImageRotateView extends View {
     ...
     */
    private int mProgressLoadedColor = 0xAFFFC107;
     ...
     * Constructor
     */
    public CircleImageRotateView(Context context) {
        super(context);
        init(context, null);
    }
     ...
     * Constructor
     */
    public CircleImageRotateView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
    }
     ...
     * Constructor
     */
    public CircleImageRotateView(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    public CircleImageRotateView(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
    ...
    public void initPlayPauseDrawable(PlayPauseDrawable playPauseDrawable) {
...
//        mPaintCover.setColor(Color.BLUE);
//        canvas.drawRect(0, 0, getWidth(), getHeight(), mPaintCover);
    ...
    public void start() {
        ...
        mHandlerRotate.postDelayed(mRunnableRotate, 100);
        if (isAutoProgress) {
